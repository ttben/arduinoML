...
public class EditorAspectDescriptorImpl implements EditorAspectDescriptor {
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0b = new String[]{"ArduinoTestLanguage.structure.Action", "ArduinoTestLanguage.structure.Actuator", "ArduinoTestLanguage.structure.Sensor", "ArduinoTestLanguage.structure.State", "ArduinoTestLanguage.structure.Transition"};
}
